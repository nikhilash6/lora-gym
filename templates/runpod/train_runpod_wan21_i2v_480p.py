"""
Wan 2.1 I2V 14B 480P LoRA Training — RunPod Edition
=====================================================
...
a CLIP image encoder for conditioning. The 480P variant uses different
weights from the 720P variant and produces lower-resolution output.

Usage:
  cd /workspace/musubi-tuner
  python /workspace/train_runpod_wan21_i2v_480p.py

  # Custom config
  python /workspace/train_runpod_wan21_i2v_480p.py --lr 5e-5 --epochs 30 --dim 32

  # Resume from a specific checkpoint
  python /workspace/train_runpod_wan21_i2v_480p.py --resume_from /workspace/outputs/my-lora-e25.safetensors

Model downloads required (add to setup_runpod.sh or download manually):
  Comfy-Org/Wan_2.1_ComfyUI_repackaged:
    split_files/diffusion_models/wan2.1_i2v_480p_14B_bf16.safetensors  (~32.8 GB)
...
OUTPUT_NAME = "annika-wan21-i2v-480p"
...
# --- Model files ---
MODEL_PATHS = {
    "dit":  f"{MODELS_DIR}/wan2.1_i2v_480p_14B_bf16.safetensors",
...
def train(args):
    ...
    if missing:
        ...
        print("  CLIP: huggingface-cli download Wan-AI/Wan2.1-I2V-14B-480P "
    ...
    print("=" * 60)
    print(f"  Wan 2.1 I2V 14B 480P (RunPod)")
    print(f"  Output: {name}")
    ...
    # =================================================================
    print("\n" + "=" * 60)
    print(f"  Step 3: Training Wan 2.1 I2V 14B 480P LoRA...")
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Wan 2.1 I2V 14B 480P LoRA Training — RunPod Edition",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Train with defaults
  python train_runpod_wan21_i2v_480p.py

  # Custom learning rate and epochs
  python train_runpod_wan21_i2v_480p.py --lr 5e-5 --epochs 30

  # Resume from a checkpoint
  python train_runpod_wan21_i2v_480p.py --resume_from /workspace/outputs/my-lora-e25.safetensors

  # Full custom config
  python train_runpod_wan21_i2v_480p.py --lr 5e-5 --dim 32 --alpha 32 --epochs 30
        """
    )
