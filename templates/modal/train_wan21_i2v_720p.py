"""
Wan 2.1 I2V 14B 720P LoRA Training — Modal Edition
====================================================
Single model, bf16 precision. Requires CLIP image encoder.

Usage:
  1. Upload dataset:  python -m modal run train_wan21_i2v_720p.py::add_to_volume_datasets
  2. Train:           python -m modal run train_wan21_i2v_720p.py::run
"""
...
def train():
    ...
    dit_path  = cached_download(comfy_21, "split_files/diffusion_models/wan2.1_i2v_720p_14B_bf16.safetensors")
    ...
    clip_path = cached_download("Wan-AI/Wan2.1-I2V-14B-720P", "models_clip_open-clip-xlm-roberta-large-vit-huge-14.pth")
    cache_vol.commit()
