"""
Wan 2.1 T2V 14B LoRA Training — Modal Edition
===============================================
Single model (no dual noise experts), bf16 precision.

Usage:
  1. Upload dataset:  python -m modal run train_wan21_t2v_14b.py::add_to_volume_datasets
  2. Train:           python -m modal run train_wan21_t2v_14b.py::run

Resume:
  python -m modal run train_wan21_t2v_14b.py::upload_resume_checkpoint --checkpoint path/to/lora.safetensors
  python -m modal run train_wan21_t2v_14b.py::run
"""
...
def train():
    ...
    dit_path = cached_download("Comfy-Org/Wan_2.1_ComfyUI_repackaged", "split_files/diffusion_models/wan2.1_t2v_14B_bf16.safetensors")
    ...
    # Train — single model, no timestep splitting
    train_cmd = [
