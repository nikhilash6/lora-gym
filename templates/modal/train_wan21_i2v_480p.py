"""
Wan 2.1 I2V 14B 480P LoRA Training — Modal Edition
====================================================
Single model, bf16 precision. Requires CLIP image encoder.
Different weights from the 720P variant.

Usage:
  1. Upload dataset:  python -m modal run train_wan21_i2v_480p.py::add_to_volume_datasets
  2. Train:           python -m modal run train_wan21_i2v_480p.py::run
"""
...
def train():
    ...
    dit_path  = cached_download(comfy_21, "split_files/diffusion_models/wan2.1_i2v_480p_14B_bf16.safetensors")
    vae_path  = cached_download(comfy_21, "split_files/vae/wan_2.1_vae.safetensors")
    t5_path   = cached_download("Wan-AI/Wan2.1-I2V-14B-480P", "models_t5_umt5-xxl-enc-bf16.pth")
    clip_path = cached_download("Wan-AI/Wan2.1-I2V-14B-480P", "models_clip_open-clip-xlm-roberta-large-vit-huge-14.pth")
    cache_vol.commit()
